...
namespace IptvPlaylistAggregator.UnitTests.Service
{
    public sealed class ChannelMatcherTests
    {
        ...
        [TestCase("Vocea Basarabiei TV (720p) [Not 24/7]", "MD", "MDVOCEABASARABIEITV")]
        ...
        [TestCase("Al Jazeera Documentary (270p) [Geo-blocked]", "ALJAZEERADOCUMENTARY")]
        ...
        [TestCase("TVR Moldova (720p) [Geo-blocked] [Not 24/7]", "TVRMOLDOVA")]
        ...
        [TestCase("Vocea Basarabiei TV (720p) [Not 24/7]", "VOCEABASARABIEITV")]
